...
if ( ! isset( $this->main_menu_slug ) ) :
 ...
 $cool_support_email = 'https://coolplugins.net/support/?utm_source=cryptocurrency-widgets&utm_medium=plugin&utm_campaign=support&utm_content=dashboard';
 $hire_devloper      = 'https://coolplugins.net/#hire-developers';
?>

 <div class="cool-body-right">
	<a href="https://coolplugins.net/?utm_source=cryptocurrency-widgets&utm_medium=plugin&utm_campaign=homepage&utm_content=dashboard" target="_blank"><img src="<?php echo esc_url( plugin_dir_url( $this->addon_file ) . '/assets/coolplugins-logo.png' ); ?>"></a>
	<ul>

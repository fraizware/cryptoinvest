...
function cdbbc_migrate_codestar()
{
    ...
    if (is_array($gen_tokens) && !empty($gen_tokens)) {
        ...
        $migrate_template['donation_settings_style'] = array(
            'main_title_typography' => array('color' => cdbbc_get_extra_option('main_title_color')),
            'main_content_typography' => array('color' => cdbbc_get_extra_option('main_content_color')),
            'main_bg_color' => cdbbc_get_extra_option('main_bg_color'),
        );
